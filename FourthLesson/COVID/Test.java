...
public class Test {
    ...
    public void addPatient(){
        patients[0]=new Patient(true, true, true, "Sputnik");
        patients[1]=new Patient(false, false, false, null);
        patients[2]=new Patient(true, false, false, "Sputnik");
